  ...
  <el-container class="app-container">
    ...
    <el-main class="main-container container-border">
      ...
      >
        ...
        <el-table-column label="关键字" width="300px" show-overflow-tooltip>
          <template v-slot="scope">
...
import { LogCondition, apiGetLogs } from "@/api/log";
...
export default defineComponent({
  ...
  setup() {
    ...
    const ruleForm = reactive<LogCondition>({
      PageIndex: 1,
      PageSize: 15,
      StartTime: null,
      EndTime: null,
    });
    const query = ref<LogCondition>({});
    const total = ref(0);
